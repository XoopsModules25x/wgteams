            ...
            <div class="modal-content">
                ...
                <div class="modal-body row">
                    <{if $member.member_image|default:false}>
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 member-panel-left" <{if $useModal|default:false}>data-toggle="modal" data-target="#memberModal<{$member.member_id}>" data-member-id="<{$member.member_id}>"<{/if}>>
                            <img class="img-fluid center  member-img<{$member.rel_imagestyle}>" src="<{$member.member_image_url}><{$member.member_image}>" alt="<{$member.member_name}>" title="<{$member.member_name}>" data-toggle="modal" data-target="#memberModal<{$member.member_id}>" data-member-id="<{$member.member_id}>">
                        </div>
                        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 member-panel-left" <{if $useModal|default:false}>data-toggle="modal" data-target="#memberModal<{$member.member_id}>" data-member-id="<{$member.member_id}>"<{/if}>>
                    <{else}>
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 member-panel-left" <{if $useModal|default:false}>data-toggle="modal" data-target="#memberModal<{$member.member_id}>" data-member-id="<{$member.member_id}>"<{/if}>>
                    <{/if}>
