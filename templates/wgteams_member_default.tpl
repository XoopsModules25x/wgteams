                <div class="member-card col-xs-12">
                    <{if $member.member_image|default:false}>
                        <div class="member-img center <{$member.rel_tablestyle}>">
                            <img class="img-responsive img-fluid center <{$member.rel_imagestyle}>" src="<{$member.member_image_url}><{$member.member_image}>" alt="<{$member.member_name}>" title="<{$member.member_name}>">
                        </div>
                    <{/if}>
