                ...
                <div class="row" id="actions">
                    ...
                    <div class="col-md-12 docs-buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="setDragMode" data-option="crop" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP}>">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn imageeditor-btn-crop <{$btn_style}>" data-method="move" data-option="0" data-second-option="-10" title="<{$smarty.const._AM_WGTEAMS_IMG_EDITOR_CROP_MOVE_UP}>">
