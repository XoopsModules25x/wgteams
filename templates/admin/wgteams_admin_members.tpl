        ...
        <{if $members_count}>
            ...
            <{foreach item=member from=$members_list}>
                <tr class="<{cycle values='odd, even'}>">
					...
					<a href="image_editor.php?op=edit_member&amp;member_id=<{$member.id}>" title="<{$smarty.const._AM_WGTEAMS_IMAGE_EDITOR}>"><img src="<{$pathModIcon16}>/image_editor.png" alt="<{$smarty.const._AM_WGTEAMS_IMAGE_EDITOR}>"></a>
