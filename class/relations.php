...
class WgteamsRelations extends XoopsObject
{
    ...
    */
    ...
    public function getFormRelations($action = false)
    {
        ...
        if ($infofieldsHandler->getCountInfofields() == 0) redirect_header('infofields.php', 3, _AM_WGTEAMS_THEREARENT_INFOFIELDS);
        if ($teamsHandler->getCountTeams() == 0)           redirect_header('teams.php', 3, _AM_WGTEAMS_THEREARENT_TEAMS);
        if ($membersHandler->getCountMembers() == 0)       redirect_header('members.php', 3, _AM_WGTEAMS_THEREARENT_MEMBERS);
