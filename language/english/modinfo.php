...
define('_MI_WGTEAMS_MAXWIDTH_DESC', 'Set the max width which is allowed for uploading images (in pixel)');
define('_MI_WGTEAMS_MAXHEIGHT', 'Maximum height upload');
define('_MI_WGTEAMS_MAXHEIGHT_DESC', 'Set the max height which is allowed for uploading images (in pixel)');
